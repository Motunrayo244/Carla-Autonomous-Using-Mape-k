...
class Autopilot(object):
  def __init__(self, vehicle, world):
    ...
    self.planner = control.Planner(self.knowledge, world)
  ...
  def set_destination(self, destination):
    # print(f"This is the destnation of the car at this time: {destination}")
    self.planner.make_plan(self.vehicle.get_transform().location, destination)
 
  def cleanup(self):
    """Cleans up resources, including sensors and the vehicle itself."""
    if self.monitor:
